// If we represent a 2d point as a single number
// where p = x << K | y, then Vector addition can 
// be performed by adding the number value
// scaling can be performed by multiplying 
// the only problem could be overflow. This could be
// avoided (but not guaranteed) by using a really large MAX_Y
// ... or by checking for overflow, although checking on each
// operation would probably be as slow as representing them
// as {x, y}, which would be simpler
